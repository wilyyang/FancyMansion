...
@Serializable
data class Book(var config: Config, var slides: MutableList<Slide>)
...
// 2 <Slide>
@Serializable
data class Slide(var id: Long, var slideImage: String = "", var title: String, var description: String = "", var count: Int = 0, var question: String, var choiceItems: MutableList<ChoiceItem> = mutableListOf())
